...
class MjCarousel extends _mjmlCore.BodyComponent {
  constructor(initialDatas = {}) {
    super(initialDatas);
    (0, _defineProperty2.default)(this, "componentHeadStyle", () => {
      const {
        length
      } = this.props.children;
      const {
    ...
    this.carouselId = _crypto.default.randomBytes(6).toString('hex');
  }
