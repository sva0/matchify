...
class MjHero extends _mjmlCore.BodyComponent {
  constructor(...args) {
    super(...args);
    (0, _defineProperty2.default)(this, "getBackground", () => makeBackgroundString([this.getAttribute('background-color'), ...(this.getAttribute('background-url') ? [`url(${this.getAttribute('background-url')})`, 'no-repeat', `${this.getAttribute('background-position')} / cover`] : [])]));
  }
